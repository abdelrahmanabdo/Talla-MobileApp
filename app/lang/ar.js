export default {
   chicChatTab : 'الرئيسية',
   closetTab : 'الدولاب',
   stylistsTab : 'المصممين',
   moreTab : 'المزيد',
   addTab : "أضف",
   welcomeLadies : 'مرحبا بكم سيداتي !',
   expectMoreFromClother :"توقع الكثير من الاحتمالات المجزية من ملابسك",
   skip : "تخطي",
   totalOrders : "مجمل طلباتي ",
   tallahMatters : "طلتك .... شئ مهم",
   organizedCloset : "دولاب مرتب , خبراء تصاميم والمزيد ....",
